...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("1", "Claro chile", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "Buscar clientes", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Actividades", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Agenda", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Solicitudes", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/clarologo.png"))); // NOI18N
